...
INSERT INTO "frpc_config" VALUES (59, 'login_fail_exit', 'true', 'bool', 'client', '第一次登陆失败后是否退出', 'true', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO "frpc_config" VALUES (134, 'custom_domains', NULL, 'string', 'proxy_http', '服务器绑定自定义域名', NULL, NULL, '用户通过 vhost_http_port 访问的 HTTP 请求如果 Host 在 custom_domains 配置的域名中，则会被路由到此代理配置的本地服务', NULL, NULL, '是(和 subdomain 两者必须配置一个)');
...
INSERT INTO "frpc_config" VALUES (136, 'locations', NULL, 'string', 'proxy_http', 'URL 路由配置', NULL, NULL, '采用最大前缀匹配的规则，用户请求匹配响应的 location 配置，则会被路由到此代理', NULL, NULL, '否');
...
INSERT INTO "frpc_config" VALUES (141, 'headers', NULL, 'map', 'proxy_http', '替换 header', NULL, NULL, 'map 中的 key 是要替换的 header 的 key，value 是替换后的内容', NULL, NULL, '否');
INSERT INTO "frpc_config" VALUES (148, 'custom_domains', NULL, 'string', 'proxy_https', '服务器绑定自定义域名', NULL, NULL, '用户通过 vhost_http_port 访问的 HTTP 请求如果 Host 在 custom_domains 配置的域名中，则会被路由到此代理配置的本地服务', NULL, NULL, '是(和 subdomain 两者必须配置一个)');
...
INSERT INTO "frpc_config" VALUES (175, 'custom_domains', NULL, 'string', 'proxy_tcpmux', '服务器绑定自定义域名', NULL, NULL, '用户通过 tcpmux_httpconnect_port 访问的 CONNECT 请求如果 Host 在 custom_domains 配置的域名中，则会被路由到此代理配置的本地服务', NULL, NULL, '是(和 subdomain 两者必须配置一个)');
...
INSERT INTO "frps_config" VALUES (5, 'proxy_bind_addr', '', 'string', 'base', '代理监听地址', '0.0.0.0', NULL, '可以使代理监听在不同的网卡地址', NULL, 0);
...
INSERT INTO "frps_config" VALUES (18, 'tls_trusted_ca_file', '', 'string', 'base', 'TLS CA 证书路径,配置此参数后,客户端必须使用TLS 连接', './data/tls/ca/ca.crt', NULL, NULL, NULL, 1);
...
INSERT INTO "frps_config" VALUES (38, 'vhost_http_port', 8080, 'int', 'http_https', '为 HTTP 类型代理监听的端口', 8080, NULL, '启用后才支持 HTTP 类型的代理，默认不启用', NULL, 0);
INSERT INTO "frps_config" VALUES (39, 'vhost_https_port', 8443, 'int', 'http_https', '为 HTTPS 类型代理监听的端口', 8443, NULL, '启用后才支持 HTTPS 类型的代理，默认不启用', NULL, 0);
...
-- ----------------------------
-- Table structure for tls_cert
-- ----------------------------
DROP TABLE IF EXISTS "tls_cert";
